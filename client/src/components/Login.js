...
function Login({host,setProgress,notify}) {
            ...
            <div className='bg-white  p-10  border border-gray-300 rounded-[5%]  w-[24rem] m-4'>
                ...
                <div className='space-y-4' >
                    <div className='space-y-1'>
                        ...
                        <input type='email' value={creadentials.email} onChange={handlechange} name='email' class='w-full border border-gray-300 text-gray-900 rounded-lg focus:ring-primary-600 focus:border-primary-600 block p-2' placeholder='manoj@richpanel.com' required='true' />
                    </div>
                    <div  className='space-y-1'>
                    ...
                    <button type="submit"  class="w-full bg-primary-700  text-white bg-[#2b4c8c] focus:ring-2 font-medium rounded-md text-sm px-5 py-3 text-center">Login</button>
