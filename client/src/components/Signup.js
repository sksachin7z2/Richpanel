    ...
    <section className='h-[100vh] flex items-center bg-blue-900'>
            ...
            <div className='bg-white w-[28%] p-10 m-auto  border border-gray-300 rounded-[5%]'>
                ...
                <div className='space-y-1'>
                        ...
                        <input type='text' name='name' class='w-full border border-gray-300 text-gray-900 rounded-lg focus:ring-primary-600 focus:border-primary-600 block p-2' placeholder='Manoj Kumar' required='' />
                    </div>
                    <div className='space-y-1'>
                    ...
                    <button type="submit" class="w-full bg-primary-700  text-white bg-blue-900 focus:ring-2 font-medium rounded-md text-sm px-5 py-3 text-center">Sign Up</button>
                    <div className='flex items-center justify-center'>
                        <p className="mt-3 text-gray-900 ">Already have an account?
                        <Link to="/Login" className="text-blue-500 m-2">Login</Link>
                    </p>
                    </div>
                </form>
            </div>
